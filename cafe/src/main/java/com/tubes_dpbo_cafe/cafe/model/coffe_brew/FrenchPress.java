...
public class FrenchPress extends Coffee {

    public FrenchPress(int id, String name, String category, String description, double price, int stock, boolean isBestSeller, String image,
    ...
    @Override
    public void brew() {
        System.out.println("Kopi " + name + " sedang diseduh dengan menggunakan metode French Press!");
    }
}
