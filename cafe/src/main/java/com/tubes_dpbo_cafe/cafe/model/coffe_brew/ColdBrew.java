...
public class ColdBrew extends Coffee {
    ...
    public ColdBrew(int id, String name, String category, String description, double price, int stock, boolean isBestSeller, String image,
    ...
    @Override
    public void brew() {
        System.out.println("Kopi " + name + " sedang diseduh dengan menggunakan metode Cold Brew!");
    }
}
