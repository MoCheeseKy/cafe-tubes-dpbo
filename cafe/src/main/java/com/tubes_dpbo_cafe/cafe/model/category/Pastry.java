...
public class Pastry extends Menu {
    public Pastry(int id, String name, String category, String description, double price, int stock, boolean isBestSeller, String image) {
