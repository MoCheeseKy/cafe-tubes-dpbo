...
public class V60 extends Coffee {

    public V60(int id, String name, String category, String description, double price, int stock, boolean isBestSeller, String image,
    ...
    @Override
    public void brew() {
        System.out.println("Kopi " + name + " sedang diseduh dengan menggunakan metode V60!");
    }
}
